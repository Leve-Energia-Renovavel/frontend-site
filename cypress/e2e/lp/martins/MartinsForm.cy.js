...
describe('Complete Form Martins', () => {
    it('should complete the form and navigate to a new page', () => {

        cy.visit(`https://new-homolog-cliente.leveenergia.com.br/lp/martins/`);
        ...
        cy.get('input[placeholder="Matrícula"]').type(dummyForm.user.registration);
