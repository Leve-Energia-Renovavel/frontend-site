            ...
            <FormContent>
                {isCompany ? (
                    <>
                        ...
                        <TextField sx={{ width: '300px' }} className="formInput" label="Email" variant="outlined" placeholder="Email" type="text" />
                        <TextField sx={{ width: '300px' }} className="formInput" label="Telefone do Responsável" variant="outlined" placeholder="Telefone do Responsável" type="text" />
                    </>
                ) : (
                    <>
                        <TextField sx={{ width: '500px' }} className="formInput" label="Nome Completo" variant="outlined" placeholder="Nome Completo" type="text" />
                        <TextField sx={{ width: '500px' }} className="formInput" label="Email" variant="outlined" placeholder="Email" type="text" />
                        <TextField sx={{ width: '200px' }} className="formInput" label="Celular" variant="outlined" placeholder="Celular" type="text" />
                        <TextField sx={{ width: '200px' }} className="formInput" label="RG" variant="outlined" placeholder="RG" type="text" />
                        <TextField sx={{ width: '200px' }} className="formInput" label="CPF" variant="outlined" placeholder="CPF" type="text" />
                        <TextField sx={{ width: '300px' }} className="formInput" label="Data de Nascimento" variant="outlined" placeholder="Data de Nascimento" type="text" />
                        <TextField sx={{ width: '300px' }} className="formInput" label="Estado Civil" variant="outlined" placeholder="Estado Civil" type="text" />
                        <TextField sx={{ width: '300px' }} className="formInput" label="Nacionalidade" variant="outlined" placeholder="Nacionalidade" type="text" />
                        <TextField sx={{ width: '300px' }} className="formInput" label="Profissão" variant="outlined" placeholder="Profissão" type="text" />
                    </>
                ...
                }} label="Número de Instalação" variant="outlined" placeholder="Número de Instalação" type="text" />
