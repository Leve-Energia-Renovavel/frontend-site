    ...
    return {
        ...
        mount: function(e) {
            var t = "/sign/" + i,
                ...
                n = this.endpoint + t + n;
            return r = document.getElementById(e), (o = document.createElement("iframe")).setAttribute("src", n), o.setAttribute("style", "width: 100%; height: 100%;"), o.setAttribute("allow", "camera;geolocation;fullscreen;gyroscope;accelerometer;magnetometer"), window.addEventListener("message", c), r.appendChild(o)
        },
        unmount: function() {
