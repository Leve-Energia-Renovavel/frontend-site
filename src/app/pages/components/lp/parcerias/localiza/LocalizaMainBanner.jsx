...
export default function LocalizaMainBanner() {
    ...
    return (
        <LocalizaMain image={localizaMainImage}>
            <h1 className="title">Colaborador Localiza, agora você pode usar energia sustentável ao garantir sua <span className="titleHighlighted">energia solar por assinatura!</span></h1>
